...
execute as @e[type=#infinity_cave:all_living,tag=!ic.molten_hammer,distance=..3] run damage @s 8 infinity_cave:magic_bypass by @p[tag=ic.molten_hammer] from @p[tag=ic.molten_hammer]
